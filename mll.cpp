...
//F.S.: Elemen C ditambahkan ke dalam list child milik P pada posisi terakhir (Insert Last). Link prev dan next tersambung dengan benar.
...
void displayMenuUtama() {
    ...
    cout << " [3] Cari Kursus (Berdasarkan Nama)    " << endl;
...
void menuKelolaModul(List &L) {
    ...
    if (pil == "1") {
        ...
        cout << " ID Kursus Target : "; cin >> idK;
        adrKursus P = searchKursus(L, idK);
        if (P) {
            cout << " ID Modul         : "; cin >> idM;
            cout << " Judul Modul      : "; cin >> jdl;
            cout << " Durasi (menit)   : "; cin >> dur;
            cout << " Kesulitan (Easy/Medium/Hard): "; cin >> diff;
...
void menuCariKursus(List L) {
    string targetNama;
    clearScreen();
    cout << "--- Daftar Kursus Tersedia ---" << endl;
    ...
    adrKursus found = nullptr;
    while (P != nullptr && found == nullptr) {
        if (P->info.namaKursus == targetNama) {
            found = P;
        }
        P = P->next;
    }
    ...
    if (found != nullptr) {
        cout << "\n[ Data Ditemukan ]" << endl;
        cout << "ID Kursus   : " << found->info.idKursus << endl;
        cout << "Nama Kursus : " << found->info.namaKursus << endl;
    } else {
        cout << "\n[!] Kursus dengan nama '" << targetNama << "' tidak ditemukan." << endl;
    }
    pauseScreen();
}
...
void menuHubungkanModul(List &L) {
    ...
    cout << "Judul     : "; cin >> jdl;
    cout << "Durasi    : "; cin >> dur;
    cout << "Diff (Easy/Medium/Hard): "; cin >> diff;
